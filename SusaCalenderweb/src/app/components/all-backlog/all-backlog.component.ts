...
@Component({
  selector: 'app-all-backlog',
  templateUrl: './all-backlog.component.html',
  styleUrls: ['./all-backlog.component.scss']
})
export class AllBacklogComponent implements OnInit {
...
getKanbanEvents(): void {
  ...
  this.kanbanEvents = [];
  this.backlogService. getAllBacklogs().subscribe(res => {
